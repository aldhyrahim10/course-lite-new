...
<div class="container">
    ...
    <div class="form-search mt-5">
        <input type="text" class="form-control search" style="width: 60%; margin: auto; height: 60px;"
        ...
        @forelse($courses as $item)
            <div class="col-lg-3 mt-4 item-content">
                <a style="text-decoration: none;"
                    href="{{ route("courses-detail-page", $item->id) }}">
                    <div class="card-product shadow">
                        <img src="{{ Storage::url($item->course_image) }}" width="100%" height="200px"
                        ...
                        <div class="card-content p-2">
                            ...
                            <p class="price">
                                Rp
                                {{ number_format($item->course_price, 0, ',', '.') }}
                            </p>
                        </div>
                    </div>
                </a>
